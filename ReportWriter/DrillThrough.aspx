<%@ Page Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="DrillThrough.aspx.cs" Inherits="WebSampleBrowser.SynReportWriter.DrillThrough" %>
                ...
                <td>
                    ...
                    <div>
                        <asp:label width="100%" style="text-align: justify;" id="label1" runat="server" text="" font="normal 16px Calibri" >
                                  This sample showcases the following capabilities of the ReportViewer.
                            <br />
                            <br />
                               •	Drillthrough Action
                            <br />
