<%@ Page Title="PredictiveAnalytics-Audit-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="GeneralRegressionAudit.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.GeneralRegressionAudit" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="generalregressionaudit.aspx/GetData" Adaptor="UrlAdaptor" />
