<%@ Page Title="PredictiveAnalytics-Ozone-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="SupportVectorMachineOzone.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.SupportVectorMachineOzone" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="supportvectormachineozone.aspx/GetData" Adaptor="UrlAdaptor" />
