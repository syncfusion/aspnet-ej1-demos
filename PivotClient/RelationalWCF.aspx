<%@ Page Title="PivotClient-WCF-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This demo for Syncfusion Essential JS1 for ASP.NET pivot client control describes how to bind the pivot data through WCF service." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="RelationalWCF.aspx.cs" Inherits="WebSampleBrowser.OlapClient.RelationalWCF" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ControlsSection">
    <ej:PivotClient ID="PivotClient1" runat="server" Url="../wcf/RelationalClientService.svc" OnServerExporting="PivotClient1_ServerExporting" Title="Relational Browser" ClientIDMode="Static">
