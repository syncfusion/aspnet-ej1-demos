<%@ Page Title="" Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="CustomAction.aspx.cs" Inherits="WebSampleBrowser.Dialog.CustomAction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <div class="control">
        ...
        <ej:Dialog ID="dialogIcon" ClientSideOnClose="onDialogClose" IsResponsive="True" EnableResize="false" Width="305" Containment=".control" Title="Audi-R8" runat="server">
            <DialogContent>
                <img src="../Content/images/dialog/r8-coupe.png" />
                <div class="cnt">
