<%@ Page Title="PredictiveAnalytics-Tips-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="RegressionTips.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.RegressionTips" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="regressiontips.aspx/GetData" Adaptor="UrlAdaptor" />
