<%@ Page Title="ReportWriter-Grouping Aggregate-ASP.NET-SYNCFUSION"   Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="GroupingAggregate.aspx.cs" Inherits="WebSampleBrowser.SynReportWriter.GroupingAggregate" %>
                ...
                <td>
                    <div>
                        <asp:label width="100%" style="text-align: justify;" id="label1" runat="server" text="" font="normal 16px Calibri">
								This sample shows the capability of exporting the RDLC report with Grouping and Aggregate functions in a table, which is located in local path into various file formats using Report Writer.
							<br />
							<br />
                        </asp:label>
