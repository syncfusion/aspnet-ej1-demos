...
{
    public partial class GanttToolbarTemplate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            var DataSource = this.GetDataSource();
            this.GanttControlToolbarTemplate.DataSource = DataSource;
            this.GanttControlToolbarTemplate.DataBind();
