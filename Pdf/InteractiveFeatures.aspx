<%@ Page Title="PDF-Interactive Features-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to create PDF invoice with interactive features in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="InteractiveFeatures.aspx.cs" Inherits="WebSampleBrowser.Pdf.InteractiveFeatures" %>
