<%@ Page Title="Schedule-Timeline View-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This example shows how grouping resource calendars in timeline views works in the ASP.NET Web Scheduler." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="HorizontalMultipleResource.aspx.cs" Inherits="WebSampleBrowser.Schedule.HorizontalMultipleResource" %>

<asp:Content ID="Content1" ContentPlaceHolderID="SampleHeading" runat="server">
    <span class="sampleName">Schedule / HorizontalMultipleResource</span>
</asp:Content>
