<%@ Page Title="PivotTreeMap-Default Functionalities-ASP.NET-SYNCFUSION" Language="C#"  MetaDescription="This demo for Syncfusion Essential JS1 for ASP.NET pivot tree map control describes how to bind the OLAP cube data from SSAS (XML/A)." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebSampleBrowser.PivotTreeMap.Default" %>
