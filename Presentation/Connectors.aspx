<%@ Page Title="Presentation-Connectors-ASP.NET-SYNCFUSION"   Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="Connectors.aspx.cs" Inherits="WebSampleBrowser.PPTX.Connectors" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
	<p>Essential Presentation library has support for inserting and editing connectors in a PowerPoint presentation.</p>
	...
	<p>
		...
		<li>Support for different connector arrow styles.</li>
