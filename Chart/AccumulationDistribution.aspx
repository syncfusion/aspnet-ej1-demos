<%@ Page Title="Chart-AccumulationDistribution-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This sample demonstrates how to render accumulation distribution indicator using Syncfusion ASP.NET Web Forms Chart control" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="AccumulationDistribution.aspx.cs" Inherits="WebSampleBrowser.Chart.AccumulationDistribution" %>
...
<asp:Content ID="ControlContent" runat="server" ContentPlaceHolderID="ControlsSection">
    <div>
        ...
        <ej:Chart ClientIDMode="Static" ID="Chart1" runat="server" Width="700" Height="600" OnClientTrackToolTip="track" IsResponsive="true" OnClientLoad="chartLoad">
            ...
            <Title Text="Accumulation Distribution Indicator"></Title>
            <Series>
            ...
            <Indicators>
                <ej:ChartIndicator Type="AccumulationDistribution" EnableAnimation="true" Fill="blue" Width="2" YAxisName="yaxis" 
                    SeriesName="Hilo">
