<%@ Page Title="PDF-Annotation Flatten-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to create 20+ type of annotations in PDF document in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="AnnotationFlatten.aspx.cs" Inherits="WebSampleBrowser.Pdf.AnnotationFlatten" %>
