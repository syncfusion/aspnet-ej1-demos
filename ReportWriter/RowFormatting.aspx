<%@ Page Title="ReportWriter-Row Formatting-ASP.NET-SYNCFUSION"   Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="RowFormatting.aspx.cs" Inherits="WebSampleBrowser.SynReportWriter.RowFormatting" %>
                ...
                <td>
                    <div>
                        <asp:label width="100%" style="text-align: justify;" id="label1" runat="server" text="" font="normal 16px Calibri">
								This sample shows the capability of exporting table report that displays conditional row formats using expression into various file formats using Report Writer.
							<br />
							<br />
                        </asp:label>
