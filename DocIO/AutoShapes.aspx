<%@ Page Title="DocIO-AutoShapes-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="AutoShapes.aspx.cs" Inherits="WebSampleBrowser.DocIO.AutoShape" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates creating Word document with Auto shapes using Essential DocIO.
        </p>
