<%@ Page Title="PivotGrid-WCF-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This demo for Syncfusion Essential JS1 for ASP.NET pivot grid control describes how to bind the OLAP cube data from SSAS (XML/A) through WCF service" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="OlapWCF.aspx.cs" Inherits="WebSampleBrowser.OlapWCF" %>

<%@ Register Assembly="Syncfusion.EJ.Pivot" Namespace="Syncfusion.JavaScript.Web" TagPrefix="ej" %>
<%@ Register Assembly="Syncfusion.EJ.Pivot" Namespace="Syncfusion.JavaScript.Models" TagPrefix="ej" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ControlsSection">
    <ej:PivotGrid ID="PivotGrid1" runat="server" url="../wcf/OlapGridService.svc" EnableGroupingBar="true" PivotTableFieldListID="PivotSchemaDesigner" ClientIDMode="Static">
    <SubTotalSettings>
     <ej:SubTotalSettings Name="Date.Fiscal">
         <Level>
             <ej:Levels Name="[Date].[Fiscal].[Fiscal Year]" ShowSubTotal="false" />
         </Level>
     </ej:SubTotalSettings>
     </SubTotalSettings>
    </ej:PivotGrid>
    <ej:PivotSchemaDesigner ID="PivotSchemaDesigner" ClientIDMode="Static" runat="server"></ej:PivotSchemaDesigner>
</asp:Content>
    ...
    <script type="text/javascript">
        ...
        window.loadPivotGridFrameTheme = function () {
            window.setTimeout(function () {
                ...
                if (pivotGridElement && pivotGridElement.model.enableGroupingBar)
