<%@ Page Title="PDF-Layers-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to create layers in PDF in ASP.NET Web Forms using Syncfusion .NET PDF library. It is also possible to annotate the layer." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="Layers.aspx.cs" Inherits="WebSampleBrowser.Pdf.Layers" %>
