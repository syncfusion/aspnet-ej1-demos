<%@ Page Title="PredictiveAnalytics-Imports-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="NeuralNetworksImports.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.NeuralNetworksImports" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="neuralnetworksimports.aspx/GetData" Adaptor="UrlAdaptor" />
