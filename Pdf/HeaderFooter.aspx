<%@ Page Title="PDF-Header and Footer-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to add header and footer in PDF document in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="HeaderFooter.aspx.cs" Inherits="WebSampleBrowser.Pdf.HeaderFooter" %>
