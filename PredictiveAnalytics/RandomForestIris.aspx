<%@ Page Title="PredictiveAnalytics-Iris-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="RandomForestIris.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.RandomForestIris" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="randomforestiris.aspx/GetData" Adaptor="UrlAdaptor" />
