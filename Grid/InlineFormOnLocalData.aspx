<%@ Page Title="Grid-Inline Form Editing-ASP.NET-SYNCFUSION" Language="C#" MetaDescription="This demo explains how to edit the records of datagrid in an inline edit form using Syncfusion ASP.NET Web Forms DataGrid control." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="InlineFormOnLocalData.aspx.cs" Inherits="WebSampleBrowser.Grid.InlineFormOnLocalData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SampleHeading" runat="server">
    <span class="sampleName">Grid / Editing / Inline form on local data</span>
</asp:Content>
    ...
    <div id="sampleProperties">
        <div class="prop-grid">
            <div class="row">
                ...
                <div class="col-md-3">
                    <ej:DropDownList ID="editMode" runat="server" SelectedItemIndex="0" ClientSideOnChange="selectChange" 
                        Width="120px">
                        <Items>
                            <ej:DropDownListItem Text="Inline Form" Value="0" />
                            <ej:DropDownListItem Text="Inline Template" Value="1" />
                        </Items>
                    </ej:DropDownList>
                </div>
            </div>
...
<asp:Content ID="ScriptContent" runat="server" ContentPlaceHolderID="ScriptSection">
    ...
    <script type="text/javascript">
        ...
        function EndRequestHandler(e) {
                        ...
                        if (dropObj.getValue() == "Inline Form")
                            $('#<%= OrdersGrid.ClientID %>').ejGrid("option", { "editSettings": { editMode: "inlineForm" } });
                        else
                            $('#<%= OrdersGrid.ClientID %>').ejGrid("option", { "editSettings": { editMode: "inlineformtemplate", inlineFormTemplateID: "#template" } });
                    }
