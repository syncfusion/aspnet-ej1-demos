<%@ Page Title="PDF-Barcode-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to create 1D and 2D barcode in the PDF document in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="Barcode.aspx.cs" Inherits="WebSampleBrowser.Pdf.Barcode" %>
