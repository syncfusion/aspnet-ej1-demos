<%@ Page Title="Presentation-Encryption and Decryption-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="EncryptAndDecrypt.aspx.cs" Inherits="WebSampleBrowser.PPTX.Security" %>

<asp:Content ID="Content3" ContentPlaceHolderID="ControlsSection" runat="server">
	<p>Essential Presentation library has support for encrypting and decrypting the PowerPoint presentation.</p>
	<p>This sample demonstrates how to encrypt and decrypt the PowerPoint document using Essential Presentation.</p>
    <div>
