<%@ Page Title="DropDownList / Server-Side Events" Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="Event.aspx.cs" Inherits="WebSampleBrowser.DropDownList.Event" %>
