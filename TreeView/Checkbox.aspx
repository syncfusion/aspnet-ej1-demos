<%@ Page Title="TreeView-Checkboxes-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" 
CodeBehind="Checkbox.aspx.cs" MetaDescription="This example demonstrates multiple nodes selection using checkbox in ASP.NET Web Forms TreeView." Inherits="WebSampleBrowser.TreeView.Checkbox" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ControlsSection" runat="server">
   <div style="width:250px">
    <ej:TreeView ID="treeview" runat="server" Height="100%" ShowCheckbox="true">
        <Nodes>
