<%@ Page Title="Default Functionalities of ASP.NET AutoComplete control | Syncfusion" MetaDescription="This example demonstrates how to create a Syncfusion ASP.NET Web Forms Autocomplete component and display a suggestion list when text is entered." Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="DefaultFunctionalities.aspx.cs" Inherits="WebSampleBrowser.AutoComplete.DefaultFunctionalities" %>
