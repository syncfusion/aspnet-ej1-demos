<%@ Page Title="DocIO-Encrypt and Decrypt-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="EncryptAndDecrypt.aspx.cs" Inherits="WebSampleBrowser.DocIO.EncryptAndDecrypt" %>
