<%@ Page Title="DocIO-Forms-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="Forms.aspx.cs" Inherits="WebSampleBrowser.DocIO.Forms" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates creating form and filling the form of the Word document using Essential DocIO.
        </p>
    <p>
