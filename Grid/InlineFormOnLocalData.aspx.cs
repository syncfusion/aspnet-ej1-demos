...
{
    public partial class InlineFormOnLocalData : System.Web.UI.Page
    {
        List<Orders> order = new List<Orders>();
        protected void Page_Load(object sender, EventArgs e)
        {
            BindDataSource();
            Session["InlineFormDataSource"] = order;
        }

        private void BindDataSource()
        {
            if ((List<Orders>)Session["InlineFormDataSource"] == null)
            {
                int orderId = 10643;
                int empId = 0;
                for (int i = 1; i < 9; i++)
            ...
            {
                order = (List<Orders>)Session["InlineFormDataSource"];
            }
        ...
        {
            List<Orders> data = Session["InlineFormDataSource"] as List<Orders>;
            ...
            Session["InlineFormDataSource"] = data;
