<%@ Page Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="MasterDetail.aspx.cs" Inherits="WebSampleBrowser.SynReportWriter.MasterDetail" %>
                ...
                <td>
                    ...
                    <div>
                        <asp:label width="100%" style="text-align: justify;" id="label1" runat="server" text="" font="normal 16px Calibri">
                            This sample showcases the Master Detail capability in ReportWriter. 
                        </asp:label>
                        <br />
                        <br />
