<%@ Page Title="DocIO-Styles-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="Styles.aspx.cs" Inherits="WebSampleBrowser.DocIO.Styles" %>

<asp:Content ID="Content3" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates how to apply built-in and custom styles to the contents available in a Word document using Essential DocIO.
        </p>
    <p>
