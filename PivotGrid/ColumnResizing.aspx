<%@ Page Title="PivotGrid-Column Resizing-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This demo for Syncfusion Essential JS1 for ASP.NET pivot grid control shows column resizing through a simple drag operation at run time" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="ColumnResizing.aspx.cs" Inherits="WebSampleBrowser.PivotGrid.Resize" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ControlsSection">
    ...
    <ej:PivotGrid ID="PivotGrid1" EnableGroupingBar="true"  EnableColumnResizing="true" runat="server" ClientIDMode="Static">
        <DataSource>
            <Rows>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="StyleSection">
    <style type="text/css">
		...
		@media (min-width: 1920px) {.row .cols-prop-area { width: 11% !important; } }
    </style>
</asp:Content>
