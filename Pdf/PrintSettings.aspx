<%@ Page Title="PDF-Page Settings-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to add pages with different settings like rotation, orientation, page size and transition in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="PrintSettings.aspx.cs" Inherits="WebSampleBrowser.Pdf.PrintSettings" %>
