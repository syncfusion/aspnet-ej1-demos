<%@ Page Title="DocIO-GroupShapes-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="GroupShapes.aspx.cs" Inherits="WebSampleBrowser.DocIO.GroupShapes" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates how to create a Word document with Group shapes using Essential DocIO.
        </p>
