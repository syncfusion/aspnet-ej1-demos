<%@ Page Title="PredictiveAnalytics-BreastCancer-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="NaiveBayesBreastCancer.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.NaiveBayesBreastCancer" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="naivebayesbreastcancer.aspx/GetData" Adaptor="UrlAdaptor" />
