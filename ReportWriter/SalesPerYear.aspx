<%@ Page Title="ReportWriter-Company Sales-ASP.NET-SYNCFUSION"   Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="SalesPerYear.aspx.cs" Inherits="WebSampleBrowser.SynReportWriter.SidePerYear" %>
                ...
                <td>
                    <div>
                        <asp:label width="100%" style="text-align: justify;" id="label1" runat="server" text="" font="normal 16px Calibri">
								This sample shows the capability of exporting the RDLC report with matrix row and column groups, which is located in local path into various file formats using Report Writer.
							<br />
							<br />	
                        </asp:label>
