<%@ Page Title="XlsIO-AttendanceTracker-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true"
    CodeFile="AttendanceTracker.aspx.cs" Inherits="WebSampleBrowser.XlsIO.AttendanceTracker" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
        Essential XlsIO can used to create attendance tracker.
    </p>
    <br />
    <p>
