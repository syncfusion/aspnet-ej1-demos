<%@ Page Title="PivotGauge-WebAPI-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This demo for Syncfusion Essential JS1 for ASP.NET pivot gauge control describes how to bind the OLAP cube data from SSAS (XML/A) through Web API service" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="OlapWebAPI.aspx.cs" Inherits="WebSampleBrowser.OlapWebApi" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ControlsSection">
    <script src='<%= Page.ResolveClientUrl("~/Scripts/excanvas.min.js")%>' type="text/javascript"></script>
    <ej:PivotGauge ID="PivotGauge1" runat="server" Url="../api/OlapGauge" IsResponsive="true" EnableTooltip="true" BackgroundColor="transparent" ClientIDMode="Static">
