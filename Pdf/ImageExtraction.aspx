<%@ Page Title="PDF-Image Extraction-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to extract images from the PDF document in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="ImageExtraction.aspx.cs" Inherits="WebSampleBrowser.Pdf.ImageExtraction" %>
