<%@ Page Title="DocIO-Default-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="DefaultFunctionalities.aspx.cs" Inherits="WebSampleBrowser.DocIO.DefaultFunctionalities" %>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td valign="middle" align="left">
                                    <asp:Label ID="Label1" runat="server" Text="Select the Order ID :  " />
