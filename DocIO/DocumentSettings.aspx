<%@ Page Title="DocIO-Document Settings-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="DocumentSettings.aspx.cs" Inherits="WebSampleBrowser.DocIO.DocumentSettings" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates how to apply various document settings such as document properties, print settings and page setup options using Essential DocIO.
        </p>
    <p>
