<%@ Page Title="PredictiveAnalytics-Wine-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="MultinomialRegressionWine.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.MultinomialRegressionWine" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="multinomialregressionwine.aspx/GetData" Adaptor="UrlAdaptor" />
