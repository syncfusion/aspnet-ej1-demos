<%@ Page Title="PDF-Rearrange Pages-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to rearrange PDF pages from an existing PDF document in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="RearrangePages.aspx.cs" Inherits="WebSampleBrowser.Pdf.RearrangePages" %>
