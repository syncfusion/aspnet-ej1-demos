<%@ Page Title="DocIO-Format Text-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="FormatText.aspx.cs" Inherits="WebSampleBrowser.DocIO.FormatText" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates formatting text with various formats such as character/text level formatting, paragraph level formatting and list level formatting.
        </p>
    <p>
