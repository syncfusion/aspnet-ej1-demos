<%@ Page Title="Tab-State Maintenance-ASP.NET-SYNCFUSION" Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="StateMaintenance.aspx.cs" MetaDescription="This demo explains how to persist the state of the tab items even when the page is refreshed in Syncfusion ASP.NET Web Forms Tab control" Inherits="WebSampleBrowser.Tab.StateMaintenance" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
     <div class="controlframe">
    <ej:Tab ID="tabStateMaintain" runat="server" EnablePersistence="true">
        <Items>
            <ej:TabItem ID="twitter" Text="Twitter">
                <ContentSection>
