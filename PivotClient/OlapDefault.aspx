<%@ Page Title="PivotClient-Default Functionalities-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This demo for Syncfusion Essential JS1 for ASP.NET pivot client control describes how to bind the OLAP cube data from SSAS (XML/A)."  MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="OlapDefault.aspx.cs" Inherits="WebSampleBrowser.OlapClient.OlapDefault" %>
