<%@ Page Title="Chart-RSI-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This sample demonstrates how to render RSI indicator using Syncfusion ASP.NET Web Forms Chart control" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="Rsi.aspx.cs" Inherits="WebSampleBrowser.Chart.Rsi" %>
    ...
    <div>
        ...
        <ej:Chart ClientIDMode="Static" ID="Chart1" runat="server" Width="700" Height="600" OnClientTrackToolTip="track"
           ...
           <Axes>
            ...
            <Indicators>
                <ej:ChartIndicator Type="RSI" EnableAnimation="true" Period="14" Fill="blue" Width="2" 
            ...
            <Title Text="RSI Indicator"></Title>
