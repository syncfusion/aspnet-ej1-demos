<%@ Page Title="Schedule-Context Menu-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This example shows how the ASP.NET Web Scheduler displays context menus on cells and appointments." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="ContextMenu.aspx.cs" Inherits="WebSampleBrowser.Schedule.ContextMenu" %>
...
<asp:Content ID="ControlContent" runat="server" ContentPlaceHolderID="ControlsSection">
    <div>
<ej:Schedule ClientIDMode="Static" runat="server" ID="Schedule1" DataSourceID="SqlData" Width="100%" Height="525px" Views="day,week,workweek,month" CurrentDate="6/5/2017">
    ...
    <CategorizeSettings Enable="true" AllowMultiple="false" Id="id" text="text" Color="color" FontColor="fontColor" />
