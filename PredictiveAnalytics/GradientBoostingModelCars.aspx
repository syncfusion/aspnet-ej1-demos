<%@ Page Title="PredictiveAnalytics-Cars-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="GradientBoostingModelCars.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.GradientBoostingModelCars" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="gradientboostingmodelcars.aspx/GetData" Adaptor="UrlAdaptor" />
