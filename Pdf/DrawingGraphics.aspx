<%@ Page Title="PDF-Drawing Graphics-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to draw shapes in PDF with difference color space and pattern in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="DrawingGraphics.aspx.cs" Inherits="WebSampleBrowser.Pdf.DrawingGraphics" %>
