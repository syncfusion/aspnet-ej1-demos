<%@ Page Title="PredictiveAnalytics-Groceries-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="AssociationRulesGroceries.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.AssociationRulesGroceries" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="associationrulesgroceries.aspx/GetData" Adaptor="UrlAdaptor" />
