...
{
    public partial class ExternalFormOnLocalData : System.Web.UI.Page
    {
        List<Orders> order = new List<Orders>();
        protected void Page_Load(object sender, EventArgs e)
        {
            BindDataSource();
            Session["ExternalFormDataSource"] = order;
        }

        private void BindDataSource()
        {
            if ((List<Orders>)Session["ExternalFormDataSource"] == null)
            {
                int orderId = 10643;
                int empId = 0;
                for (int i = 1; i < 9; i++)
            ...
            {
                order = (List<Orders>)Session["ExternalFormDataSource"];
            }
        ...
        {
            List<Orders> data = Session["ExternalFormDataSource"] as List<Orders>;
