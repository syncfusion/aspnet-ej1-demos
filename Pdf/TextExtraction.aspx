<%@ Page Title="PDF-Text Extraction-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to extract the text from the PDF in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="TextExtraction.aspx.cs" Inherits="WebSampleBrowser.Pdf.TextExtraction" %>
