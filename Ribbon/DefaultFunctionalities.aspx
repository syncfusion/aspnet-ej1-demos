<%@ Page Title="Ribbon-Default-ASP.NET-SYNCFUSION" Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="DefaultFunctionalities.aspx.cs" MetaDescription="This example demonstrates the default functionalities in a ASP.NET Web Forms Ribbon" Inherits="WebSampleBrowser.Ribbon.DefaultFunctionalities" %>

<asp:Content ID="Content1" ContentPlaceHolderID="SampleHeading" runat="server">
    <span class="sampleName">Ribbon / DefaultFunctionalities</span>
</asp:Content>
                                        ...
                                        <ContentCollection>
                                            ...
                                            <ej:TabContent>
                                                <ContentGroupCollection>
                                                    ...
                                                    <ej:ContentGroup Id="font" Text="Font Color" ToolTip="Font Color" Type="Custom" ContentID="fontcolor">                                                   
                                                    </ej:ContentGroup>
                                                    <ej:ContentGroup Id="fill" Text="Fill Color" ToolTip="Fill Color" Type="Custom" ContentID="fillcolor">                                                        
                                                    </ej:ContentGroup>
                                                </ContentGroupCollection>
                                    ...
                                    <ej:TabGroup Text="Views" AlignType="Rows">
                                        <ContentCollection>
                                            <ej:TabContent>
                                                ...
                                                <ContentGroupCollection>
                                                    <ej:ContentGroup Id="zoomin" Text="Zoom In" ToolTip="Zoom In">
                                                        <ButtonSettings ContentType="TextAndImage" ImagePosition="ImageTop" PrefixIcon="e-icon e-ribbon e-undoe-ribbon e-zoomin" Click="executeAction" Type="Button" />
                                                    </ej:ContentGroup>
                                                    <ej:ContentGroup Id="zoomout" Text="Zoom Out" ToolTip="Zoom Out">
                                                        <ButtonSettings ContentType="TextAndImage" ImagePosition="ImageTop" PrefixIcon="e-icon e-ribbon e-zoomout" Click="executeAction" Type="Button" />
                                                    </ej:ContentGroup>
                                                    <ej:ContentGroup Id="fullscreen" Text="Full Screen" ToolTip="Full Screen">
                                                        <ButtonSettings ContentType="TextAndImage" ImagePosition="ImageTop" PrefixIcon="e-icon e-ribbon e-fullscreen" Click="executeAction" Type="Button" Width="73" />
                                                    </ej:ContentGroup>
                                                </ContentGroupCollection>
                                            </ej:TabContent>
                                        </ContentCollection>
