<%@ Page Title="PredictiveAnalytics-Bfeed-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="CoxRegressionBfeed.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.CoxRegressionBfeed" %>
        ...
        <ej:Tab ID="output" runat="server" ClientSideOnActive="onTabChange">
            <Items>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="coxregressionbfeed.aspx/GetData" Adaptor="UrlAdaptor" />
                ...
                <ej:TabItem ID="pmml" Text="PMML">
                    <ContentSection>
                        <div class="tab_height">
                             <textarea id="pmmlContent" rows="100" cols="400"><%= Session["pmmlFile"]%></textarea>
                        </div>
                    </ContentSection>
                </ej:TabItem>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var rscript = "<%= Session["rscript"]%>";
                ...
                editorPMML = CodeMirror.fromTextArea(document.getElementById("pmmlContent"), {
                    matchBrackets: true,
