...
{
    public partial class GanttColumnTemplate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            var resource = ResourceDataContext.GetResourceData();
            var DataSource = GetTaskData();
            this.ColumnTemplate.DataSource = DataSource;
            this.ColumnTemplate.DataBind();
            this.ColumnTemplate.Resources = resource;         
        }
