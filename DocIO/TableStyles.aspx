<%@ Page MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="TableStyles.aspx.cs" Inherits="WebSampleBrowser.DocIO.TableStyles" %>

<asp:Content ID="Content3" ContentPlaceHolderID="ControlsSection" runat="server">
   <p>This sample demonstrates how to apply a predefined built-in style to a table in the Word document using Essential DocIO.</p>
