...
{
    public partial class CustomTool : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            this.customTool.ToolsList = new List<string>() { "creation", "navigation", "addressBar", "editing", "copyPaste", "getProperties", "customTool", "searchBar" };            
        }
