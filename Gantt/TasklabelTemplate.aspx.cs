...
{
    public partial class TasklabelTemplate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            var resource = TaskLabelResourceDataContext.GetTaskLabelResourceData();
            var DataSource = GetTaskData();
            this.GanttTaskLabelControl.DataSource = DataSource;
            this.GanttTaskLabelControl.DataBind();
            this.GanttTaskLabelControl.Resources = resource;   
        }
        ...
        public List<TaskDetails> GetTaskData()
        {
            ...
            tasks[0].SubTasks[0].SubTasks.Add(new TaskDetails()
            {
                ...
                Duration = 5,
                Progress = "100",
                ResourceID = new List<object>() { 1 , 5}
            });
            tasks[0].SubTasks[0].SubTasks.Add(new TaskDetails()
            {
                TaskID = 4,
            ...
            tasks[0].SubTasks[0].SubTasks.Add(new TaskDetails()
            {
                ...
                Duration = 5,
                Progress = "100",
                ResourceID = new List<object>() { 6 , 1}
            });
            tasks[0].SubTasks[0].SubTasks.Add(new TaskDetails()
            {
                TaskID = 6,
            ...
            tasks[0].SubTasks[1].SubTasks.Add(new TaskDetails()
            {
                ...
                Progress = "60",
                Predecessors = "6FS",
                ResourceID = new List<object>() { 2 , 3}
            });
            tasks[0].SubTasks[1].SubTasks.Add(new TaskDetails()
            {
                TaskID = 9,
                ...
                Progress = "100",
                Predecessors = "6FS",
                ResourceID = new List<object>() { 3 , 6}
            });
            tasks[0].SubTasks[1].SubTasks.Add(new TaskDetails()
            {
                TaskID = 10,
            ...
            tasks[0].SubTasks[2].SubTasks.Add(new TaskDetails()
            {
                ...
                Progress = "0",
                Predecessors = "15FS",
                ResourceID = new List<object>() { 3 , 4}
            });
            tasks[0].SubTasks[2].SubTasks.Add(new TaskDetails()
            {
                TaskID = 17,
        ...
        public class TaskLabelResourceDataContext
        {
            ...
            public static List<Resources> GetTaskLabelResourceData()
            {
