<%@ Page Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="ProductSalesAnalysis.aspx.cs" Inherits="WebSampleBrowser.SynReportWriter.ProductSalesAnalysis" %>
            ...
            <tr>
                <td>
                    ...
                    <div>
                        ...
                        <br />
                        <br />
                            •	Gauge, Chart, and Table Report Items
                        </asp:label>
                        <br />
                        <br />
