<%@ Page Title="DocIO-Employee Report-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="EmployeeReport.aspx.cs" Inherits="WebSampleBrowser.DocIO.EmployeeReport" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates generating an employee report using Mail merge functionality of Essential DocIO.
        </p>
    <p>
