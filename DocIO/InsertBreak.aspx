<%@ Page Title="DocIO-Insert Break-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="InsertBreak.aspx.cs" Inherits="WebSampleBrowser.DocIO.InsertBreak" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates inserting break into the Word document using Essential DocIO.
        </p>
    <p>
