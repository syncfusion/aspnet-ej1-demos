<%@ Page Title="ReportWriter-SalesDashboard-ASP.NET-SYNCFUSION"   Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="SalesDashboard.aspx.cs" Inherits="WebSampleBrowser.SynReportWriter.SalesDashboard" %>
                ...
                <td>
                    <div>
                        <asp:label width="100%" style="text-align: justify;" id="label1" runat="server" text="" font="normal 16px Calibri">
								This samples shows the capability of exporting the report with Chart and Tablix report items into various file formats using Report Writer.
							<br />
							<br />
                        </asp:label>
