<%@ Page Language="C#" Title="Tab-Scrollable Tab-ASP.NET-SYNCFUSION" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="TabScroll.aspx.cs" MetaDescription="This example demonstrates scrolling support to display a large number of tabs in a ASP.NET Web Forms Tab control." Inherits="WebSampleBrowser.Tab.TabScroll" %>
