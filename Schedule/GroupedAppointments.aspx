<%@ Page Title="" Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="GroupedAppointments.aspx.cs" Inherits="WebSampleBrowser.Schedule.GroupedAppointments" %>
...
<asp:Content ID="ControlContent" runat="server" ContentPlaceHolderID="ControlsSection">
    <div>
        <ej:schedule clientidmode="Static" runat="server" id="Schedule1" width="100%" height="525px" cellwidth="40px" currentdate="5/6/2017" showcurrenttimeindicator="false">
