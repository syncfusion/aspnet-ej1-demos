<%@ Page Title="PDF-File Attachments-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to attach document to PDF in ASP.NET Web Forms using Syncfusion .NET PDF library. It is also possible to delete and extract attachment from PDF." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="Attachments.aspx.cs" Inherits="WebSampleBrowser.Pdf.Attachments" %>
