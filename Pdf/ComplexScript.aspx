<%@ Page Title="PDF-Complex Script-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to draw complex script language text such as Thai, Hindi and Tamil in PDF document in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="ComplexScript.aspx.cs" Inherits="WebSampleBrowser.Pdf.ComplexScript" %>
