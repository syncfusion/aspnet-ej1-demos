<%@ Page Title="PDF-Encryption Support-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to protect PDF document with advanced encryption standards in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="EncryptionSupport.aspx.cs" Inherits="WebSampleBrowser.Pdf.EncryptionSupport" %>
