<%@ Page Title="PDF-Replace Fonts-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to replace fonts from PDF in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="ReplaceFont.aspx.cs" Inherits="WebSampleBrowser.Pdf.ReplaceFont" %>
