<%@ Page Title="ReportWriter-Mail Merge-ASP.NET-SYNCFUSION"   Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="MailMerge.aspx.cs" Inherits="WebSampleBrowser.SynReportWriter.MailMerge" %>
                ...
                <td>
                    <div>
                        <asp:label width="100%" style="text-align: justify;" id="label1" runat="server" text="" font="normal 16px Calibri">
								This sample shows the capability of exporting mail merge like Employee details report which is located in local path into various file formats using Report Writer.
							<br />
							<br />
                        </asp:label>
