<%@ Page Title="ReportWriter-Product List-ASP.NET-SYNCFUSION"   Language="C#" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="WebSampleBrowser.SynReportWriter.ProductList" %>
                ...
                <td>
                    <div>
                        <asp:label width="100%" style="text-align: justify;" id="label1" runat="server" text="" font="normal 16px Calibri">
								This sample shows the capability of exporting Product catalog report that displays product information using list, grouping and images into various file formats using Report Writer.
							<br />
							<br />
                        </asp:label>
