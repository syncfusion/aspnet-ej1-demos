<%@ Page Title="DocIO-Mail Merge Event-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="MailMergeEvent.aspx.cs" Inherits="WebSampleBrowser.DocIO.MailMergeEvent" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates formatting the Mail merged data using Mail merge events of Essential DocIO.
        </p>
    <p>
