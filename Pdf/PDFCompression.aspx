<%@ Page Title="PDF-PDF Compression Level-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to create compressed PDF in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="PDFCompression.aspx.cs" Inherits="WebSampleBrowser.Pdf.PDFCompression" %>
