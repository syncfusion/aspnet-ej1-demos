<%@ Page Title="Diagram-Symbol Palette-ASP.NET-SYNCFUSION" Language="C#" MetaDescription="This example illustrates ASP.NET WEB diagram's symbol palette feature that allows to predefining shapes in a palette and can be easily dragged and dropped into canvas." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="SymbolPalette.aspx.cs" Inherits="WebSampleBrowser.Diagram.SymbolPalette" %>
