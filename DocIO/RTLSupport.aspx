<%@ Page Title="DocIO-RTL Support-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="RTLSupport.aspx.cs" Inherits="WebSampleBrowser.DocIO.RTLSupport" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates creating a Word document with Right-To-Left language text using Essential DocIO.
        </p>
    <p>
