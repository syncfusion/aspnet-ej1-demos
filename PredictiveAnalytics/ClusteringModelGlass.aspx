<%@ Page Title="PredictiveAnalytics-Glass-ASP.NET-SYNCFUSION"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Samplebrowser.Master" CodeBehind="ClusteringModelGlass.aspx.cs" Inherits="WebSampleBrowser.PredictiveAnalytics.ClusteringModelGlass" %>
                    ...
                    <ContentSection>
                        <div class="tab_height" id="gridpadding">
                            <ej:Grid ID="OutputGrid"
                                ...
                                <DataManager URL="clusteringmodelglass.aspx/GetData" Adaptor="UrlAdaptor" />
