<%@ Page Title="PDF-Import and Stamp-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to add watermark in PDF document in ASP.NET Web Forms using Syncfusion .NET PDF library. It is possible watermark with text and images." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="ImportAndStamp.aspx.cs" Inherits="WebSampleBrowser.Pdf.ImportAndStamp" %>
