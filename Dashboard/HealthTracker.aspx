...
<body>
    <form id="form1" runat="server">
        <div id="stepAnnotation" style="display: none">
            <img style="width: 130px; height: 130px" src="../Content/Dashboard/health-tracker/images/step.png"/>
        </div>
        <div id="floorAnnotation" style="display: none">
            <img style="width: 130px; height: 130px" src="../Content/Dashboard/health-tracker/images/floor.png"/>
        </div>
        <div class="trackerheader">
            <div class="sampleheader container">
                <div class="col-xs-12">
                    <div class="title">
                        <img class="heartsym" src="../Content/Dashboard/health-tracker/images/heart-img.png" />
        ...
        <div class="samplecontainer container">
            ...
            <div id="heading row">
                <div class="col-xs-6">
                    <img class="personpic" src="../Content/Dashboard/health-tracker/images/person.png" />
                    <p class="persondet">
                        <br />
                        <b>Andrew Fuller</b><br />
                        34 years / 175 cm
                    </p>
                    <img class="personsym" src="../Content/Dashboard/health-tracker/images/personimg.png" />
                </div>
                <div class="col-xs-6">
                    <div class="bmiwight">
                        <div class="bmidiv">
            ...
            <div class="topspace row">
                ...
                <div class="addbutton col-xs-6">
                    ...
                    <img class="add" src="../Content/Dashboard/health-tracker/images/Add.png" />
                </div>
            </div>
