<%@ Page Title="PDF-Customtag-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="Example [C#] to create tagged PDF or accessible PDF with custom tags in ASP.NET Web Forms using Syncfusion .NET PDF library." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="CustomTag.aspx.cs" Inherits="WebSampleBrowser.Pdf.CustomTag" %>
