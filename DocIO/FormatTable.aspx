<%@ Page Title="DocIO-Format Table-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="FormatTable.aspx.cs" Inherits="WebSampleBrowser.DocIO.FormatTable" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates how to format the tables of the Word document using Essential DocIO.</p>
    <p>
