<%@ Page Title="DocIO-Footnotes and Endnotes-ASP.NET-SYNCFUSION"   MasterPageFile="~/samplebrowser.master" Language="C#" AutoEventWireup="true" CodeBehind="FootnotesAndEndnotes.aspx.cs" Inherits="WebSampleBrowser.DocIO.FootnotesAndEndnotes" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ControlsSection" runat="server">
    <p>
    This sample illustrates the insertion of footnotes and endnotes in a Word document using Essential DocIO.
        </p>
    <p>
