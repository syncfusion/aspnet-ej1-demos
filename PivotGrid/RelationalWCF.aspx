<%@ Page Title="PivotGrid-WCF-ASP.NET-SYNCFUSION"   Language="C#" MetaDescription="This demo for Syncfusion Essential JS1 for ASP.NET pivot grid control describes how to bind the pivot data through WCF service." MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="RelationalWCF.aspx.cs" Inherits="WebSampleBrowser.RelationalWCF" %>

<%@ Register Assembly="Syncfusion.EJ.Pivot" Namespace="Syncfusion.JavaScript.Web" TagPrefix="ej" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ControlsSection">
    <ej:PivotGrid ID="PivotGrid1" runat="server" url="../wcf/RelationalGridService.svc" EnableGroupingBar="true" PivotTableFieldListID="PivotSchemaDesigner" ClientIDMode="Static">
    </ej:PivotGrid>
    ...
    <script type="text/javascript">
        ...
        function renderPivotGrid(args) {
            ...
            $("#PivotGrid1").ejPivotGrid({
                url: "../wcf/RelationalGridService.svc", enableGroupingBar: groupingBar, pivotTableFieldListID: fieldlist ? "PivotSchemaDesigner" : ""
            });
            if (fieldlist)
